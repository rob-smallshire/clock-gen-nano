...
# AVR_UPLOADTOOL_BAUD (NO DEFAULT)
#     the baud rate at which to communicate with the programmer
...
if(AVR_UPLOADTOOL_BAUD)
   set(
           AVR_UPLOADTOOL_OPTIONS "-b ${AVR_UPLOADTOOL_BAUD}"
   )
endif(AVR_UPLOADTOOL_BAUD)
...
function(add_avr_executable EXECUTABLE_NAME)
   ...
   add_custom_target(
      get_status
      ${AVR_UPLOADTOOL} -p ${AVR_MCU} -c ${AVR_PROGRAMMER} -P ${AVR_UPLOADTOOL_PORT} ${AVR_UPLOADTOOL_OPTIONS} -n -v
   ...
   add_custom_target(
      get_fuses
      ${AVR_UPLOADTOOL} -p ${AVR_MCU} -c ${AVR_PROGRAMMER} -P ${AVR_UPLOADTOOL_PORT} ${AVR_UPLOADTOOL_OPTIONS} -n
         -U lfuse:r:-:b
         -U hfuse:r:-:b
